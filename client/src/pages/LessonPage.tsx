...
import { cancelDialogue, getNamedDialogueVoiceMode, speakDialogue, speakNamedDialogue, speakNamedTurn, type NamedDialogueVoiceMode } from "@/lib/dialogueSpeech";
      ...
      {passageText ? (
        isListening && !submitted ? (
          <div className="mt-4 space-y-2">
            <GuidedListening text={passageText} itemId={`listening:${kind}:${question.id}`} compact label="শুনতে চাপুন · script লুকানো" />
