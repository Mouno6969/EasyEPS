/** Canonical 60-chapter EPS-TOPIK curriculum list — aligned to 「NEW 한국어 표준교재」 (2024년 개정판):
 *  Book 1 일상생활 한국어 = chapters 1–30, Book 2 직장생활 한국어 = chapters 31–60. */
...
const RAW: Array<[string, string, string]> = [
  ...
  ["생활용품", "দৈনন্দিন প্রয়োজনীয় জিনিস", "Daily Necessities"],
  ["위치와 장소", "অবস্থান ও স্থান", "Locations and Places"],
  ["동작과 사물", "কাজ ও বস্তু", "Actions and Objects"],
  ...
  ["은행", "ব্যাংক", "Bank"],
  ["외국인 근로자 지원 기관", "বিদেশি কর্মী সহায়তা কেন্দ্র", "Foreign Workers Support Center"],
  ...
  ["동료와의 관계", "সহকর্মীর সঙ্গে সম্পর্ক", "Colleague Relationships"],
  ["성희롱 및 성추행 예방", "যৌন হয়রানি ও সহিংসতা প্রতিরোধ", "Sexual Harassment and Assault Prevention"],
  ...
  ["플라스틱 고무 성형", "প্লাস্টিক ও রাবার মোল্ডিং", "Plastic and Rubber Molding"],
  ["섬유 제조", "বস্ত্র উৎপাদন", "Textile Manufacturing"],
  ["가구 제작", "আসবাবপত্র তৈরি", "Furniture Making"],
  ["건축 시공", "ভবন নির্মাণ", "Building Construction"],
  ["토목 시공", "সিভিল ইঞ্জিনিয়ারিং কাজ", "Civil Engineering"],
  ["농작물 재배", "ফসল চাষ", "Crop Cultivation"],
  ["사육 관리", "গবাদিপশু ব্যবস্থাপনা", "Livestock Management"],
  ["연안 어업과 양식", "উপকূলীয় মৎস্য ও জলজ চাষ", "Coastal Fishing and Aquaculture"],
  ["선체 건조", "জাহাজের হাল নির্মাণ", "Ship Hull Construction"],
  ["광물 자원 개발 생산", "খনিজ সম্পদ উন্নয়ন ও উৎপাদন", "Mineral Resource Development and Production"],
  ["산림 자원 조성", "বনসম্পদ ব্যবস্থাপনা", "Forest Resource Management"],
  ["숙박 서비스", "আবাসন সেবা", "Accommodation Services"],
  ["음식 조리", "খাদ্য প্রস্তুতি", "Food Preparation"],
  ["산업 안전 및 보건 표지", "শিল্প নিরাপত্তা ও স্বাস্থ্য চিহ্ন", "Industrial Safety and Health Signs"],
  ["산업 안전 및 보건 수칙", "শিল্প নিরাপত্তা ও স্বাস্থ্য বিধি", "Industrial Safety and Health Regulations"],
  ["산업 안전 및 위생 장비", "নিরাপত্তা ও স্বাস্থ্য সুরক্ষা সরঞ্জাম", "Industrial Safety and Hygiene Equipment"],
  ["산업 재해 및 응급 처치", "শিল্প দুর্ঘটনা ও প্রাথমিক চিকিৎসা", "Industrial Accidents and First Aid"],
  ...
  ["근로자 보험", "কর্মসংস্থান ও শ্রমিক বীমা", "Employment Insurance"],
];
